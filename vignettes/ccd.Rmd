...
```{r fig_ccd, fig.width=6.5,fig.height=2.5,fig.dpi=300,fig.cap=knitr::asis_output("**Figure 1**. SURD decomposition results between climatic and topographic factors and npp.")}
